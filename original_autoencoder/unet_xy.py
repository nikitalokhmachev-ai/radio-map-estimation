...
class UNet_V2_XY_V1(nn.Module):
    '''
    Based on (but doesn't inherit from) UNet_V2
    '''

    def __init__(self, in_channels=2, latent_channels=4, out_channels=1, features=27, xy_features=8):
        super().__init__()

        self.encoder1 = UNet_V2_XY_V1._block(in_channels, features, name="enc1")
        self.pool1 = nn.AvgPool2d(kernel_size=2, stride=2)
        self.encoder2 = UNet_V2_XY_V1._block(features, features, name="enc2")
        self.pool2 = nn.AvgPool2d(kernel_size=2, stride=2)
        self.encoder3 = UNet_V2_XY_V1._block(features, features, name="enc3")
        ...
        self.decoder3 = UNet_V2_XY_V1._block((features) * 2, features, name="dec3")
        self.upconv2 = nn.ConvTranspose2d(features, features, kernel_size=2, stride=2)
        self.decoder2 = UNet_V2_XY_V1._block((features) * 2, features, name="dec2")
        self.upconv1 = nn.ConvTranspose2d(features, features, kernel_size=2, stride=2)
        self.decoder1 = UNet_V2_XY_V1._block(features * 2, features, name="dec1")
