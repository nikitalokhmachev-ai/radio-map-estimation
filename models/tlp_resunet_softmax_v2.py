...
class Decoder(nn.Module):
    ...
    def __init__(self, dec_in, dec_out, n_dim, leaky_relu_alpha=0.3):
        ...
        self.conv2d_map = nn.ConvTranspose2d(n_dim, dec_out, kernel_size=(1,1), stride=1, padding=0)
        self.conv2d_tx = nn.ConvTranspose2d(n_dim, dec_out, kernel_size=(1,1), stride=1, padding=0)
    ...
    def forward(self, x, u_skip1, u_skip2, u_skip3):
        ...
        map = self.leaky_relu(self.conv2d_map(x))
        tx_loc = self.conv2d_tx(x)
        return map, tx_loc