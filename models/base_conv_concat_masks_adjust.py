...
class Encoder(nn.Module):
    def __init__(self, enc_in, enc_out, n_dim, n_dim_mask, leaky_relu_alpha=0.3):
        ...
        self.conv2d_1 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.conv2d_2 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.average_pooling2d = nn.AvgPool2d(kernel_size=(2, 2))
        self.conv2d_3 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.conv2d_4 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.conv2d_5 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.average_pooling2d_1 = nn.AvgPool2d(kernel_size=(2, 2))
        self.conv2d_6 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.conv2d_7 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
        self.conv2d_8 = nn.Conv2d(n_dim + n_dim_mask, n_dim, kernel_size=(3, 3), padding='same')
